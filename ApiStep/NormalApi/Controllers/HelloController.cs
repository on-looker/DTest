...
namespace NormalApi.Controllers
{
    public class HelloController : ApiController
    {
        ...
        public dynamic GetServices<T>()
        {
            ...
            HttpParameterBinding binmgs;
            IActionValueBinder asdads;
            DefaultActionValueBinder bindsdl;
            ModelBinderParameterBinding asd;
            FormatterParameterBinding asaddas;
            MediaTypeFormatter formmatterl;
            XmlMediaTypeFormatter  asad;
            FormUrlEncodedMediaTypeFormatter sdsfdfs;
            FormDataCollection cl = new FormDataCollection("");
            JQueryMvcFormUrlEncodedFormatter sadsa;
